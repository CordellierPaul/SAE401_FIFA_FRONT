    ...
    <div class="flex items-center justify-center flex-col">
        ...
        <div class="*:m-2">
            <label class="input input-bordered flex items-center gap-2">
                ...
                <input id="inputEmail" type="text" class="grow" placeholder="Email" v-model="compte.CompteEmail" />
            </label>
            <label class="input input-bordered flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4 opacity-70">
                ...
                <input id="inputMdp" type="password" class="grow" value="" placeholder="Mot de passe" v-model="compte.CompteMdp" />
            </label>
        </div>
        ...
        <button class="btn btn-accent m-5" @click="boutonConnexionCompte" id="btSeConnecter">SE CONNECTER</button>
